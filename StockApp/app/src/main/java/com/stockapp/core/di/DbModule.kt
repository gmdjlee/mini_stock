...
object DbModule {
    ...
    fun provideAppDb(@ApplicationContext context: Context): AppDb {
        return Room.databaseBuilder(
            ...
            .addMigrations(MIGRATION_1_2, MIGRATION_2_3, MIGRATION_3_4, MIGRATION_4_5, AppDb.MIGRATION_5_6, AppDb.MIGRATION_6_7, AppDb.MIGRATION_7_8, AppDb.MIGRATION_8_9, AppDb.MIGRATION_9_10)
